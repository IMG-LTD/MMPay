...
bash -n "$ROOT_DIR/scripts/smoke-docker-compose.sh"
...
bash -n "$ROOT_DIR/scripts/governance/verify-backup-restore-drill-evidence.sh"
...
node --check "$ROOT_DIR/scripts/governance/verify-backup-restore-drill-evidence.mjs"
