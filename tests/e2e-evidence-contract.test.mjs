...
describe('MP-8 redacted evidence contract', () => {
  ...
  it('rejects placeholders, mock provider mode, and missing failure scenarios', async () => {
    const evidenceFile = await writeEvidenceFile(validEvidence().replace('Provider environment: sandbox', 'Provider environment: mock').replace('replay: event evt_replay_redacted duplicate rejected', ''));
