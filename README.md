...
`v0.8.3` is a P5 release-governance hardening patch. It keeps MMPay as an
...
on `/api/admin/audit/verify`, and adds signed backup/restore drill evidence
...
```text
ghcr.io/img-ltd/mmpay-app:v0.8.3
```
